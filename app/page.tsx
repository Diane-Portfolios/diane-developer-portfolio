...
export default function Page() {
  return (
    <section>
      ...
      <p className="mb-4">
        {`I’m a software engineer who loves making tools that actually make life easier—especially after years working as a personal trainer and in food service. I’ve worked with everything from gym software to restaurant POS systems, so I know how to take real-world headaches and create working solutions. I also love talking to clients and figuring out exactly what they need, which makes the software I build both useful and easy to use.`}
      </p>
      <div className="my-8">
        <BlogPosts />
      </div>
